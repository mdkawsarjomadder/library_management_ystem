    ...
    var pdf = QuestPDF.Fluent.Document.Create(container =>
    {
        container.Page(page =>
        {
                ...
                .Column(column =>
                {
                    column.Item()
                        .Row(row =>
                        {
                            ...
                            row.RelativeItem()
                                .AlignRight()
                                .Text($"Date: {DateTime.Now:dd MMM yyyy, ddd}")
                                .FontSize(10);
                        });
                   ...
                   table.Header(header =>
                    ...
                    foreach (var item in issueBooks)
                    {
                        ...
                        table.Cell()
                            .Border(1)
                            .Padding(5)
                            .Text(item.IssueDate.ToString("dd MMM yyyy"));
                        ...
                        table.Cell()
                            .Border(1)
                            .Padding(5)
                            .Text(item.ReturnDate?.ToString("dd MMM yyyy") ?? "-");
            ...
            page.Footer()
                ...
                {
                    row.RelativeItem()
                        .Text($"Generated: {DateTime.Now:dd MMM yyyy ddd HH:mm:ss}")
                        .FontSize(9);
